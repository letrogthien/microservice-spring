...
public class QToken extends EntityPathBase<Token> {
    ...
    private static final long serialVersionUID = -1216164401L;
    ...
    public final StringPath jwt = createString("jwt");

    public final BooleanPath revoked = createBoolean("revoked");

    public final EnumPath<com.example.demo.type.TokenType> type = createEnum("type", com.example.demo.type.TokenType.class);
